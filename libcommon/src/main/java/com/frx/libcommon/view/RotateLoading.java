...
public class RotateLoading extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        color = Color.WHITE;
        width = PixUtils.dp2px(DEFAULT_WIDTH);
        shadowPosition = PixUtils.dp2px(DEFAULT_SHADOW_POSITION);
        ...
        if (null != attrs) {
            ...
            width = typedArray.getDimensionPixelSize(R.styleable.RotateLoading_loading_width, PixUtils.dp2px(DEFAULT_WIDTH));
